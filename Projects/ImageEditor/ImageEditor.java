...
//			  System.out.println("Performing Motion Blur");
...
//			  System.out.println("Performing Emboss");
			  Image modifiedImage = new Image(width,height);
...
//			  System.out.println("Performing Inversion");
			  Image modifiedImage = new Image(width,height);
...
//			  System.out.println("Performing Grayscale");
			  Image modifiedImage = new Image(width,height);
  ...
  public Image motionBlur(Image image,int n){
    ...
    Image newImage = new Image(x,y);
      ...
      for(int j=0;j<y;j++){
        ...
        for(int k=i;k<(n+i);k++){
          if(k==x){//if it is at the end of the pixels
            break;
          }
          numberOfPixelsUsed++;
